{
  ...
  cfg = config.jjw.editors.spacemacs;
in {
  options.jjw.editors.spacemacs = let
  ...
  config = lib.mkIf cfg.enable (
    ...
    in {
      ...
      home.activation.install-spacemacs = lib.hm.dag.entryAfter ["installPackages"] ''
        PATH="${pkgs.git}/bin:${pkgs.openssh}/bin:$PATH" $DRY_RUN_CMD ${pkgs.git-acquire}/bin/git-acquire -l ~/.emacs.d -r 4882f70e6541275969b09b52394bb9af563852f4 https://github.com/syl20bnr/spacemacs.git
